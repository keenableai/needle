...
def test_extract_arxiv_from_text_and_doi():
    assert extract_arxiv("https://example.com", "see arXiv:2506.12345 for details") == "2506.12345"
    assert extract_arxiv("https://doi.org/10.48550/arXiv.2506.12345", "") == "2506.12345"
    assert extract_arxiv("https://example.com/paper", "no id here") is None
...
def test_extract_pmid():
    ...
    assert extract_pmid("https://x.com", "nothing") is None
...
def test_extract_pmcid():
    ...
    assert extract_pmcid("https://x.com") is None
...
def test_extract_doi():
    ...
    assert extract_doi("https://x.com", "no doi") is None


def test_extract_doi_strips_publisher_suffix():
    assert (
        extract_doi("https://www.frontiersin.org/articles/10.3389/fimmu.2026.1856481/full", "")
