...
STOPWORDS = frozenset(
    {
        ...
        "is", "of", "on", "or", "the", "to", "via", "with", "using", "based", "toward",
        "towards", "over", "under", "this", "that", "these", "those", "we", "our", "it",
        "its", "their", "study", "paper", "approach", "method", "methods", "results",
        "novel", "new", "efficient", "effective", "robust", "improved", "improving",
        "learning", "model", "models", "analysis", "framework", "system", "systems",
    }
)
