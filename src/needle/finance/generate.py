...
from needle.finance.canon import registrable_domain
from needle.finance.models import (
    FILINGDOC_FIELD,
    FILINGDOC_SPEC,
...
from needle.finance.projection import (
    MIN_DOC_CHARS,
...
from needle.finance.sources import EdgarClient, quarterly_facts
